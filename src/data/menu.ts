...
export const BOHNICE_MENU_ITEMS: MenuItem[] = [
  ...
  { id: "bo-pita", number: 2, category: "kebab-gemuse", name: { cs: "Pita", en: "Pita" }, description: { cs: "Kebab Gemüse v pita chlebu se zeleninou a omáčkou.", en: "Kebab Gemüse in pita bread with vegetables and sauce." }, price: "149 Kč", image: IMG("pita-kebab.webp") },
  { id: "bo-box-maly", number: 3, category: "kebab-gemuse", name: { cs: "Malý box", en: "Small box" }, description: { cs: "Malý box s kebabem Gemüse, zeleninou a omáčkou.", en: "Small box with Gemüse kebab, vegetables and sauce." }, price: "119 Kč", image: IMG("box-bez.webp") },
  ...
  { id: "bo-box-velky", number: 5, category: "kebab-gemuse", name: { cs: "Velký box", en: "Large box" }, description: { cs: "Velký box s kebabem Gemüse, zeleninou a omáčkou.", en: "Large box with Gemüse kebab, vegetables and sauce." }, price: "149 Kč", image: IMG("box-bez.webp") },
  ...
  { id: "bo-talir-maly", number: 7, category: "kebab-gemuse", name: { cs: "Malý talíř", en: "Small plate" }, description: { cs: "Malý talíř s kebabem Gemüse, zeleninou a přílohou.", en: "Small plate with Gemüse kebab, vegetables and a side." }, price: "179 Kč", image: IMG("talir-bez.webp") },
  ...
  { id: "bo-talir-velky", number: 9, category: "kebab-gemuse", name: { cs: "Velký talíř", en: "Large plate" }, description: { cs: "Velký talíř s kebabem Gemüse, zeleninou a přílohou.", en: "Large plate with Gemüse kebab, vegetables and a side." }, price: "209 Kč", image: IMG("talir-bez.webp") },
  ...
  { id: "bo-pizza-spinachi", number: 34, category: "pizza32", name: { cs: "Spinachi", en: "Spinachi" }, description: { cs: "Rajčatová omáčka, mozzarella, špenát, česnek a balkánský sýr.", en: "Tomato sauce, mozzarella, spinach, garlic and Balkan cheese." }, price: "220 Kč", image: IMG("spinachi.webp"), tags: ["vegetarian"] },
